...
class CandidateService extends HttpServlet {
    ...
    private CandidateController candidateController = new CandidateController(candidateDAO)
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (pathInfo == null | "/" == pathInfo) {
            ...
            try {
                List<Candidate> candidates = candidateController.getCandidatesWithSkills()
                String jsonCandidates = gson.toJson(candidates)
